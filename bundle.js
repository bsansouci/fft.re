var MyBundle = (function (exports) {
  ...
  function fftInplace(complex) {
    ...
    for(var k$1 = 0 ,k_finish$1 = m - 1 | 0; k$1 <= k_finish$1; ++k$1){
      ...
      complex[k$1] = add(c, new_com);
      complex[k$1 + m | 0] = sub(c, new_com);
    }
    return /* () */0;
  }
  ...
  function fft(data, maxAmplitude, _) {
    ...
    for(var i$$1 = 0 ,i_finish = m - 1 | 0; i$$1 <= i_finish; ++i$$1){
      spectrum[i$$1] = norm(data_cp[i$$1]);
      if (spectrum[i$$1] > maxAmplitudeFrequency) {
        maxAmplitudeFrequency = spectrum[i$$1];
      }
  ...
  function hannWindow(data) {
    ...
    for(var i$$1 = 0 ,i_finish = bucketSize - 1 | 0; i$$1 <= i_finish; ++i$$1){
      var multiplier = 0.5 - 0.5 * Math.cos(two_pi * i$$1 / total);
      var com = data[i$$1];
      data[i$$1] = /* record */[
  ...
  function hammingWindow(data) {
    ...
    var total = bucketSize - 1 | 0;
    for(var i$$1 = 0 ,i_finish = bucketSize - 1 | 0; i$$1 <= i_finish; ++i$$1){
      var multiplier = 0.54 - 0.46 * Math.cos(two_pi * i$$1 / total);
      var com = data[i$$1];
      data[i$$1] = /* record */[
        /* re */com[/* re */0] * multiplier,
        /* im */com[/* im */1]
  ...
  function getMaxAmplitude(data) {
    ...
    for(var i$$1 = 0 ,i_finish = size - 1 | 0; i$$1 <= i_finish; ++i$$1){
      var x = data[i$$1];
  ...
  function generateSineInplace(data, frequency, samplingRate, $staropt$star, $staropt$star$1, _) {
    ...
    for(var i$$1 = 0 ,i_finish = size - 1 | 0; i$$1 <= i_finish; ++i$$1){
      ...
      for(var k = 0 ,k_finish = numberOfSines - 1 | 0; k <= k_finish; ++k){
        var coef = (k << 1) + 1 | 0;
        x += (Math.sin(offset * coef + i$$1 * frequency * coef / samplingRatef * pi * 2) / coef);
      }
      data[i$$1] = /* record */[
        /* re */x,
        /* im */0
    ...
    while(true) {
      ...
      if (exit$1 === 2) {
        if (self_hi !== -2147483648) {
          ...
          exit = 1;
        } else if (eq(other, one$1) || eq(other, neg_one)) {
          return self;
          ...
          var approx = lsl_(div$2(half_this, other), 1);
          var exit$2 = 0;
          ...
          if (exit$2 === 3) {
            ...
            return add$1(approx, div$2(rem, other));
          }
        ...
        if (exit$3 === 2) {
          if (self_hi < 0) {
            if (other_hi$1 < 0) {
              ...
              return neg$1(div$2(neg$1(self), other));
            }
          } else if (other_hi$1 < 0) {
            return neg$1(div$2(self, neg$1(other)));
          } else {
            var res = zero$1;
            var rem$1 = self;
  ...
  function mod_$1(self, other) {
    var y = mul$1(div$2(self, other), other);
    return add$1(self, neg$1(y));
  }

  function div_mod(self, other) {
    var quotient = div$2(self, other);
      ...
      if (i >= len) {
        ...
        if (c >= 69) {
          if (c >= 88) {
            ...
            f[/* signedconv */5] = true;
            f[/* uppercase */7] = true;
            f[/* conv */10] = String.fromCharCode(lowercase$1(c));
            _i = i + 1 | 0;
            continue ;
          }
        } else {
  ...
  var Type_mismatch = create$1("CamlinternalFormat.Type_mismatch");
  ...
  function cycle(x, k) {
    ...
    a = i$1(a, b, c, d, k[0], 6, -198630844);
    d = i$1(d, a, b, c, k[7], 10, 1126891415);
    c = i$1(c, d, a, b, k[14], 15, -1416354905);
    b = i$1(b, c, d, a, k[5], 21, -57434055);
    a = i$1(a, b, c, d, k[12], 6, 1700485571);
    d = i$1(d, a, b, c, k[3], 10, -1894986606);
    c = i$1(c, d, a, b, k[10], 15, -1051523);
    b = i$1(b, c, d, a, k[1], 21, -2054922799);
    a = i$1(a, b, c, d, k[8], 6, 1873313359);
    d = i$1(d, a, b, c, k[15], 10, -30611744);
    c = i$1(c, d, a, b, k[6], 15, -1560198380);
    b = i$1(b, c, d, a, k[13], 21, 1309151649);
    a = i$1(a, b, c, d, k[4], 6, -145523070);
    d = i$1(d, a, b, c, k[11], 10, -1120210379);
    c = i$1(c, d, a, b, k[2], 15, 718787259);
    b = i$1(b, c, d, a, k[9], 21, -343485551);
    x[0] = a + x[0] | 0;
    x[1] = b + x[1] | 0;
    x[2] = c + x[2] | 0;
    x[3] = d + x[3] | 0;
  ...
  function assign(st1, st2) {
    blit$4(st2[/* st */0], 0, st1[/* st */0], 0, 55);
    st1[/* idx */1] = st2[/* idx */1];
    return /* () */0;
  }
  ...
  function int64(s, bound) {
    if (le(bound, /* int64 */[
      ...
      while(true) {
        ...
        var v = mod_$1(r, n);
        if (gt(sub$1(r, v), add$1(sub$1(max_int$3, n), /* int64 */[
                    /* hi */0,
                    /* lo */1
                  ]))) {
          continue ;
  ...
  var Undefined = create$1("CamlinternalLazy.Undefined");
  ...
  function create$4($staropt$star, initial_size) {
  ...
  function drawArc(env, param, radx, rady, start, stop, isPie, matrix, param$1) {
    ...
    for(var i = start_i; i <= stop_i; ++i){
      ...
      if ((i - start_i | 0) < 3) {
        _3(set, elementData, (i - start_i | 0) + elementArrayOffset | 0, div$1(ii, vertexSize));
      } else {
        var jj = (imul((i - start_i | 0) - 3 | 0, 3) + elementArrayOffset | 0) + 3 | 0;
        _3(set, elementData, jj, div$1(vertexArrayOffset, vertexSize));
        _3(set, elementData, jj + 1 | 0, _2(get, elementData, jj - 1 | 0));
        _3(set, elementData, jj + 2 | 0, div$1(ii, vertexSize));
      }
    }
  ...
  function drawImage(param, param$1, param$2, param$3, param$4, subx, suby, subw, subh, env) {
    ...
    _3(set, elementArray, jj, div$1(ii, vertexSize));
    _3(set, elementArray, jj + 1 | 0, div$1(ii, vertexSize) + 1 | 0);
    _3(set, elementArray, jj + 2 | 0, div$1(ii, vertexSize) + 2 | 0);
    _3(set, elementArray, jj + 3 | 0, div$1(ii, vertexSize) + 1 | 0);
    _3(set, elementArray, jj + 4 | 0, div$1(ii, vertexSize) + 2 | 0);
    _3(set, elementArray, jj + 5 | 0, div$1(ii, vertexSize) + 3 | 0);
  ...
  var IntMap = Make$2(/* module */[/* compare */intCompare]);
  ...
  var IntPairMap = Make$2(/* module */[/* compare */compare$9]);
  ...
  var hotreloadData = create$4(/* None */0, 10);
  ...
  var pauseFns = create$4(/* None */0, 10);
  ...
  function setup(env) {
    ...
    return /* record */[
            /* time */0,
            /* checked */loadImage$2("assets/checked.png", /* None */0, env),
            /* unchecked */loadImage$2("assets/unchecked.png", /* None */0, env),
            /* hamming */false,
            /* hann */false
          ];
  }
  ...
  function draw(state, env) {
    ...
    var match = mouse(env);
    if (state[/* hamming */3]) {
      image(state[/* checked */1], /* tuple */[
            700,
            100
          ], /* None */0, /* None */0, env);
    } else {
      image(state[/* unchecked */2], /* tuple */[
            700,
            100
          ], /* None */0, /* None */0, env);
    }
    ...
    strokeWeight(1, env);
    for(var i = 1 ,i_finish = div$1(8192, timeWindowSeconds | 0) - 1 | 0; i <= i_finish; ++i){
    ...
    for(var i$1 = 0; i$1 <= 4095; ++i$1){
      ...
      if (i$1 === j) {
        fill$4(color(255, 255, 255, 255), env);
      } else {
        fill$4(color(255 - (spectrum[i$1] * 255 | 0) | 0, spectrum[i$1] * 255 | 0, 0, 255), env);
      }
      rectf(/* tuple */[
            10 + i$1 * 5,
            600 - height$$1
  ...
  run(setup, /* None */0, /* Some */[draw], /* None */0, /* None */0, /* Some */[mouseDown], /* None */0, /* None */0, /* None */0, /* None */0, /* () */0);
